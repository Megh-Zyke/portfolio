...
import {
    ...
    SiTensorflow, SiPytorch, SiHuggingface, SiLangchain, SiOpenai, SiFirebase
} from 'react-icons/si';
    ...
    return (
        <>
            <div style={iconRowStyle}>
                ...
                <SiFirebase title="Firebase" style={iconStyle} onMouseOver={e => e.target.style.color = '#FF421D'} onMouseOut={e => e.target.style.color = '#94a3b8'} />
            </div>
